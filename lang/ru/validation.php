...
return [
    ...
    'attributes' => [
        ...
        'password' => '"Пароль"',
        'region_name' => '"Наименование субъекта РФ"',
        'region_id' => '"Наименование субъекта РФ"',
        'description ' => '"Краткое описание"',
        'avatar' => 'Изображение профиля',
        'org_name_short' => 'Краткое наименование организации',
        'address' => 'Адрес',
        'phone' => 'Номер телефона',
        'org_inn' => 'ИНН организации',
        'oktmo' => 'ОКТМО',
        'org_chief_fio' => 'ФИО руководителя организации',
        'seat' => 'Должность',
        'country' => 'Страна',
        'name' => 'Наименование',
        'org_type_id' => '"Тип организации"',
        'status' => '"Статус"',
        'competition_type' => '"Тип мероприятия"',
        'close_date' => '"Дата закрытия"',
        'open_date' => '"Дата открытия"',
        'competition_id' => 'ID соревнования',
        'team_name' => '"Наименование команды"',
        'discipline' => '"Дисциплина"',
        'team_trainer' => '"Тренер команды"',
        'video_url' => '"Ссылка на видеоролик"',
        'country_id' => '"Страна"',
        'event_place' => '"Место проведения мероприятия"',
        'event_address' => '"Адрес проведения мероприятия"',
        ...
        'inn' => '"ИНН организации"',
        'ogrn' => '"ОГРН / ОГРНИП"',
        'year_founded' => '"Год основания / регистрации"',
        'members_amount' => '"Количество зарегистрированных членов"',
        'website' => '"Вебсайт"',
        'accept_form' => '"Согласие на обработку персональных данных"',
        'participant_name' => '"ФИО участника"',
        'age_option' => '"Возрастная категория"',
        'settlement' => '"Населенный пункт"',
        'command_name' => '"Наименование команды"',
        'sports_category' => '"Спортивный разряд"',
        'organization_inn' => '"ИНН организации"',
        'org_type' => 'Форма организации',
        'experience' => 'Опыт работы',
        'no_inn' => 'Регистрация без ИНН',
        'url' => '"Ссылка"',
        'education_document' => '"Документ об образовании"',
        'gender' => '"Пол"',
        'passport_scans[]' => 'Сканы паспорта',
        'passport_scans' => 'Сканы паспорта',
        'pay_way' => 'Вариант оплаты',
        'initial_payment' => 'Первоначальный взнос',
        'media_consents' => '"Согласие на обработку персональных данных"',
        'consent_personal_data' => '"Согласие на осуществление прямых контактов"',
        // и т.д.
    ],
